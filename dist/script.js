...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markType) {
    var selector = portfolioWrapper.querySelectorAll(".".concat(markType));
  ...
  portfolioMenu.addEventListener('click', function (e) {
    ...
    if (target && target.tagName == 'LI') {
      portfolioMenuElements.forEach(function (elem) {
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); //Validation all phone inputs
...
var modals = function modals() {
  var btnPressed; //If any btn pressed => true;
