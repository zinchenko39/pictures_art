...
function openModal(selector, scroll) {
  ...
  document.body.style.overflow = 'hidden';
  document.body.style.marginRight = "".concat(scroll, "px"); // selector.classList.remove('animated', 'fadeOut');
  // selector.classList.add('animated', 'fadeIn');
}
function closeModal(selector) {
  var windows = document.querySelectorAll('[data-modal]');
  windows.forEach(function (item) {
    item.style.display = 'none'; // selector.classList.remove('animated', 'fadeIn');
